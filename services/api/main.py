...
from app.runtime import chapters, files, health, metrics, upload  # noqa: E402
...
app = FastAPI(
    title="Qwen Video Chapters API",
    description=(
        "Auto-generate chapters, thumbnails & summaries for long-form video "
        "with local Qwen2.5-VL, backed by Backblaze B2"
    ),
    version="0.1.0",
    lifespan=lifespan,
)
...
app.include_router(chapters.router, tags=["library"])
