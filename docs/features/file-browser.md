...
- Client route-construction tests: `pnpm --filter @qwen-video-chapters/web test`
- Full verify command: `pnpm lint && pnpm --filter @qwen-video-chapters/web test && pnpm build && pnpm lint:api && pnpm test:api && pnpm check:structure`
